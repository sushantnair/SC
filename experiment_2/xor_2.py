...
def epoch(w1, w2, row, perceptron):
    global flag_z1, flag_z2, flag_y, z1, z2, t
    #if flag == False:
    if flag_z1 == False and perceptron == 'z1':
        ...
        if z1_out == t:
            flag_z1 = True
        print(row, (x1, x2, t, z1_in, z1_out, w11, w21, Δw11, Δw21), 'hare krishna')
        if row < 4:
            row = row + 1
        else:
            print('Next Epoch is getting generated now...')
            row = 1
        print('Value of row for nextfunction call: ', row)
        epoch(w11_new, w21_new, row, perceptron)
        ...
        if z2_out == t:
            flag_z2 = True
        print(row, (x1, x2, t, z2_in, z2_out, w12, w22, Δw12, Δw22))
        row += 1
        epoch(w12_new, w22_new, row, perceptron)
        ...
        if y_out == t:
            flag_y = True
        print(row, (z1, z2, t, y_in, y_out, v1, v2, Δv1, Δv2))
        row += 1
        epoch(v1_new, v2_new, row, perceptron)
    #elif flag == True:
    if flag_z1 == True and perceptron == 'z1':
        if row == 1:
            x1 = 0
            x2 = 0
            t = 0
...
def main():
    ...
    z1_list = epoch(w1 = 0, w2 = 0, row = 1, perceptron = 'z1')
    w11 = 1 #z1_list[-1][5]
    w21 = 1 #z1_list[-1][6]
    ...
    z2_list = epoch(w1 = 0, w2 = 0, row = 1, perceptron = 'z2')
    w12 = 1 #z2_list[-1][5]
    w22 = 1 #z2_list[-1][6]
